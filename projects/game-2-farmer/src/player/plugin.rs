...
impl Plugin for PlayerPlugin {
    fn build(&self, app: &mut App) {
        app.add_event::<PlayerDirectionChange>()
            ...
            .add_systems(Update, (update_player_direction, update_player_animation_state, update_sprite_texture_atlas, animated_player_sprite, update_player_animation_indices, update_player_target))
            .add_systems(Update, (draw_sprite_bounding_box.run_if(debug_enable), debug_player_state.run_if(debug_enable), draw_target_block.run_if(debug_enable)))
